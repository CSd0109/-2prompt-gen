        ...
        >
          ...
          >
            ...
            <div className="text-sm text-slate-700 leading-relaxed space-y-4">
              ...
              <p>
                As part of our commitment to democratizing advanced visual synthesis, 2Prompt Gen provides verified prompt patterns to millions of artists with zero paywalls. This ensures maximum prompt fidelity, consistent lighting rigs, and zero token corruption across all generative platforms.
              </p>
            </div>
          </div>
        </div>
