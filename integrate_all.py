...
with open("bulk_prompts_transferred.json", "r") as f:
    bulk_prompts = json.load(f)

# Keep the high-end video prompts and web UI prompts too
existing_videos_ui = [
  {
    "id": "vid-1",
...
all_data = bulk_prompts + existing_videos_ui
...
export const SAMPLE_PROMPTS: PromptItem[] = {json.dumps(all_data, indent=2)};
...
print(f"data.ts successfully updated with {len(all_data)} complete prompts under 2Prompt brand!")
